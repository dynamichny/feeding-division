        ...
        .then(result1 => {
          db.collection("groups")
            ...
            .then(result2 => {
              ...
              requests.splice(
                requests.findIndex(request => request.uid == user.uid),
                1
              );
              db.collection("groups")
                .doc(this.groupName)
    ...
    removeUser(user) {
      db.collection("groups")
        ...
        .then(result => {
          ...
          groupUsers.splice(
            groupUsers.findIndex(groupUser => groupUser.uid == user.uid),
            1
          );
          db.collection("groups")
            .doc(this.groupName)
      ...
      if (!this.isAdmin) {
        db.collection("groups")
          ...
          .then(result => {
            ...
            users.splice(
              users.findIndex(user => user.uid === this.currentUser.uid),
              1
            );
            db.collection("groups")
              .doc(this.groupName)
